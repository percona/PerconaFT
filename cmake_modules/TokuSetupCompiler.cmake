...
macro(set_ldflags_if_supported)
  foreach(flag ${ARGN})
    string(REGEX REPLACE "-" "_" temp_flag ${flag})
    check_cxx_compiler_flag(${flag} HAVE_${temp_flag})
    if (HAVE_${temp_flag})
...
# strip -Wvla for mysql-5.6.22 builds since tokuft uses variable length arrays
string(REGEX REPLACE "-Wvla" "" CMAKE_C_FLAGS "${CMAKE_C_FLAGS}")
string(REGEX REPLACE "-Wvla" "" CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS}")
