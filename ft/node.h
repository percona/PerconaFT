...
void toku_ftnode_put_msg(const toku::comparator &cmp, const ft_update_info& update_fun,
...
void toku_ft_bn_apply_msg(const toku::comparator &cmp, const ft_update_info& update_info,
                          BASEMENTNODE bn, const ft_msg &msg, txn_gc_info *gc_info,
                          uint64_t *workdone, STAT64INFO stats_to_update);

void toku_ft_leaf_apply_msg(const toku::comparator &cmp, const ft_update_info& update_fun,
                            FTNODE node, int target_childnum,
