...
void manager_unit_test::test_reference_release_lt(void) {
    ...
    locktree *blt = mgr.get_lt(b, my_comparator);
    invariant_notnull(alt);
    locktree *clt = mgr.get_lt(c, my_comparator);
    invariant_notnull(alt);
    ...
    locktree *blt2 = mgr.get_lt(b, my_comparator);
    invariant(blt2 == blt);
    locktree *alt2 = mgr.get_lt(a, my_comparator);
    invariant(alt2 == alt);
